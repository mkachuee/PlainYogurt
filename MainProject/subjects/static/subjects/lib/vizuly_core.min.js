	...
	Axiis:{
		...
		link_stroke:function(a,b){
			if(a.values == null || a.values.length == 0)
				return "#755D09"; // end nodes
			else if(a.depth == 0)
				return "#000000"; // start node
			else
				return "#755D09"; // normal nodes
		},
		link_stroke_opacity:function(b,c){
			return 1;//a.value()(b.target)<=0?.15:.35
		},
		node_fill:function(a,b){
			if(a.values == null || a.values.length == 0)
				return "#FED136"; // end nodes
			else if(a.depth == 0)
				return "#000000"; // start node
			else
				return "#36B31D"; // normal nodes
		},
		node_fill_opacity:function(b,c){
			return 1;//a.value()(b)<=0?.15:.4444444
		},
		node_stroke:function(a,b){
			if(a.values == null || a.values.length == 0)
				return "#A18422"; // end nodes
			else if(a.depth == 0)
				return "#000000"; // start node
			else
				return "#206912"; // normal nodes
			return "#36B31D";
		},
